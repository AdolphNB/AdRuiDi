...
#define MSG_CTRL_WATERFLOODING_OPEN 0X97
#define MSG_CTRL_WATERFLOODING_STOP 0X98

#define MSG_CTRL_DEWATER_OPEN		0X95
#define MSG_CTRL_DEWATER_STOP		0X96
...
#define MSG_SHOW_UPDATE_STATISTICS  0X26
